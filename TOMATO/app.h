...
public:
  ...
  void initializeRestaurants()
  {
    ...
    restaurant1->addMenuItem(MenuItem("P3", "Lassi", 40));

    Restaurant *restaurant2 = new Restaurant("Haldiram", "Delhi");
    ...
    Restaurant *restaurant4 = new Restaurant("Punjabi Dhaba", "Delhi");
    restaurant4->addMenuItem(MenuItem("P1", "Butter Chicken", 180));
    restaurant4->addMenuItem(MenuItem("P2", "Naan", 40));
    restaurant4->addMenuItem(MenuItem("P3", "Dal Makhani", 120));
    ...
    cout << "Restaurants initialized successfully!" << endl;
  }
